...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        await query.message.edit_text(
            ...
            buttons = [[
                InlineKeyboardButton('HI', url="https://t.me/botuptest")
            ], [
                InlineKeyboardButton('Gʀᴏᴜᴘ', url='t.me/JINN_GROUP'),
                InlineKeyboardButton('Cʜᴀɴɴᴇʟ', url='https://t.me/MALLU_MOVIES_PROK')
            ], [
